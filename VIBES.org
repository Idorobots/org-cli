...
#+begin_src bash
org analyze -n 5 examples/ARCHIVE_small
#+end_src
...
Empty result:
#+begin_example
org tags --filter-not-complete VIBES.org
#+end_example
...
Results found:
#+begin_example
org tags --filter-complete VIBES.org
#+end_example
...
Example:
#+begin_example
org tags -n 4 --details tests/fixtures/simple.org
#+end_example
