...
*** TODO Rich text support                                                                     :TUI:
Use Pythons Rich library to support extra nice TUI features.

Replace the explicit ~colorama~ color handling with Rich's ~console.print()~ with markup. Please preserve the same color scheme as with Colorama.
...
Add syntax highlighting on the detailed display of org nodes in the ~tasks list~ command output.
