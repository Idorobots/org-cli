...
- State "REWORKED"   from "TODO"       [2026-02-25 Wed 21:10] \\
  It introduced some bugs and left the old filters implementation "for posterity". Needs some cleanup.
:END:
...
Please add integration tests for the =query= command. I'd like those tests to run various queries on the fixture files and check for expected results.
...
- Use it for repeated task filtering
