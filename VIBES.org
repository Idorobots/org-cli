...
The command will parse the query, compile it into a node processing function and execute the function on the input nodes producing results. The results will be then printed to the console, item by item on separate lines.
