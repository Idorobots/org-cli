...
Please add a =not= function for negating conditions: =not(<subquery>)= results in =true= value if subquery is falsy and =false= if it is truthy.
...
╭─ Error ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│ Invalid query syntax: expected one of '!=', ')', '*', '**', '+', ',', '-', '.', '/', '<', '<=', '==', '>', '>=', '[', 'and(?![A-Za-z0-9_])', 'as(?![A-Za-z0-9_])', 'in(?![A-Za-z0-9_])',                        │
│ 'matches(?![A-Za-z0-9_])', 'mod(?![A-Za-z0-9_])', 'or(?![A-Za-z0-9_])', 'quot(?![A-Za-z0-9_])', 'rem(?![A-Za-z0-9_])', '|' at 0:18                                                                              │
│                                                                                                                                                                                                                 │
...
- ~--filter-gamify-exp-above X~ - 'select(.properties["gamify_exp"] > X)'
- ~--filter-gamify-exp-below X~ - 'select(.properties["gamify_exp"] < X)'
- ~--filter-repeats-above X~ - 'select()'
- ~--filter-repeats-below X~ - 'select()'
- ~--filter-date-from X~ - 'select(.latest_timestamp >= X)'
- ~--filter-date-until X~ - 'select(.latest_timestamp <= X)'
- ~--filter-property P=V~ - 'select(.properties[P] == V)'
- ~--filter-level L~ - 'select(.level == L)'
- ~--filter-tag REGEX~ - 'select(.tags[] matches REGEX)'
- ~--filter-heading REGEX~ - 'select(.heading matches REGEX)'
- ~--filter-body REGEX~ - 'select(.body matches REGEX)'
- ~--filter-completed~ - 'select(.todo in $done_keys)'
- ~--filter-not-completed~ - 'select(.todo in $todo_keys)'

- ~--order-by file-order~ - '.[]'
- ~--order-by file-order-reversed~ - '.[] | reverse'
- ~--order-by level~ - 'sortby(.level)'
- ~--order-by timestamp-asc~ - 'sortby(.latest_timestamp)'
- ~--order-by timestamp-desc~ - 'sortby(.latest_timestamp) | reverse'
- ~--order-by gamify-exp-asc~ - 'sortby(.properties["gamify_exp"])'
- ~--order-by gamify-exp-desc~ - 'sortby(.properties["gamify_exp"]) | reverse'
